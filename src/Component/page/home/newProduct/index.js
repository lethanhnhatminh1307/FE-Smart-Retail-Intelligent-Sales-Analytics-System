...
import { useEffect,useContext, useRef, createRef, useState } from 'react';
...
function NewProduct() {
    ...
    const newCategory = category.slice(0,4)
    const numberRef = newCategory.length+1;
    const ref = [];
